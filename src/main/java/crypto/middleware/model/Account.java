...
import crypto.middleware.serialize.UserJsonSerializer;
...
public class Account {
    ...
    public Account(String name, String surname, String email, String address, String password, String cvu, String wallet) {
        this.name = name;
